...
module Pipeline_10(
  ...
  input  [33:0] io_in_bits_dram_addr,	// @[generators/gemmini/src/main/scala/gemmini/Pipeline.scala:7:14]
  ...
  output [33:0] io_out_bits_dram_addr,	// @[generators/gemmini/src/main/scala/gemmini/Pipeline.scala:7:14]
  ...
  reg  [33:0] stages_0_dram_addr;	// @[generators/gemmini/src/main/scala/gemmini/Pipeline.scala:21:21]
  ...
  reg  [33:0] stages_1_dram_addr;	// @[generators/gemmini/src/main/scala/gemmini/Pipeline.scala:21:21]
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        stages_0_dram_addr = {_RANDOM[5'h8][31:9], _RANDOM[5'h9][10:0]};	// @[generators/gemmini/src/main/scala/gemmini/Pipeline.scala:21:21]
        stages_0_spad_addr = {_RANDOM[5'h9][31:11], _RANDOM[5'hA], _RANDOM[5'hB][14:0]};	// @[generators/gemmini/src/main/scala/gemmini/Pipeline.scala:21:21]
        stages_0_I = _RANDOM[5'hB][30:15];	// @[generators/gemmini/src/main/scala/gemmini/Pipeline.scala:21:21]
        stages_0_J = {_RANDOM[5'hB][31], _RANDOM[5'hC][14:0]};	// @[generators/gemmini/src/main/scala/gemmini/Pipeline.scala:21:21]
        stages_1_cmd_inst_funct = _RANDOM[5'hC][21:15];	// @[generators/gemmini/src/main/scala/gemmini/Pipeline.scala:21:21]
        stages_1_cmd_rs1 = {_RANDOM[5'hD][31:15], _RANDOM[5'hE], _RANDOM[5'hF][14:0]};	// @[generators/gemmini/src/main/scala/gemmini/Pipeline.scala:21:21]
        stages_1_dram_addr = {_RANDOM[5'h14][31:24], _RANDOM[5'h15][25:0]};	// @[generators/gemmini/src/main/scala/gemmini/Pipeline.scala:21:21]
        stages_1_spad_addr = {_RANDOM[5'h15][31:26], _RANDOM[5'h16], _RANDOM[5'h17][29:0]};	// @[generators/gemmini/src/main/scala/gemmini/Pipeline.scala:21:21]
        stages_1_I = {_RANDOM[5'h17][31:30], _RANDOM[5'h18][13:0]};	// @[generators/gemmini/src/main/scala/gemmini/Pipeline.scala:21:21]
        stages_1_J = _RANDOM[5'h18][29:14];	// @[generators/gemmini/src/main/scala/gemmini/Pipeline.scala:21:21]
        valids_0 = _RANDOM[5'h18][30];	// @[generators/gemmini/src/main/scala/gemmini/Pipeline.scala:21:21, :22:25]
        valids_1 = _RANDOM[5'h18][31];	// @[generators/gemmini/src/main/scala/gemmini/Pipeline.scala:21:21, :22:25]
      `endif // RANDOMIZE_REG_INIT
    end // initial
