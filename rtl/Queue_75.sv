...
module Queue_75(
  ...
  ram_6x7 ram_ext (	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  ...
  assign io_deq_bits_total_rows = _ram_ext_R0_data[6:3];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
endmodule
