...
module Queue_15(
  ...
  ram_2x109 ram_ext (	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
    ...
    .W0_clk  (clock),
    .W0_data ({io_enq_bits_data, io_enq_bits_mask, io_enq_bits_address, io_enq_bits_source, io_enq_bits_size, io_enq_bits_opcode})	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  );
  ...
  assign io_deq_bits_source = _ram_ext_R0_data[15:6];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_address = _ram_ext_R0_data[36:16];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_mask = _ram_ext_R0_data[44:37];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
