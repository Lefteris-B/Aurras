...
module PE(
  ...
  input  [7:0] io_inR,	// @[generators/gemmini/src/main/scala/gemmini/Transposer.scala:101:16]
               io_inD,	// @[generators/gemmini/src/main/scala/gemmini/Transposer.scala:101:16]
  output [7:0] io_outL,	// @[generators/gemmini/src/main/scala/gemmini/Transposer.scala:101:16]
               io_outU,	// @[generators/gemmini/src/main/scala/gemmini/Transposer.scala:101:16]
  input        io_dir,	// @[generators/gemmini/src/main/scala/gemmini/Transposer.scala:101:16]
               io_en	// @[generators/gemmini/src/main/scala/gemmini/Transposer.scala:101:16]
);
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        reg_0 = _RANDOM[/*Zero width*/ 1'b0][7:0];	// @[generators/gemmini/src/main/scala/gemmini/Transposer.scala:110:24]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  assign io_outL = reg_0;	// @[generators/gemmini/src/main/scala/gemmini/Transposer.scala:110:24]
  assign io_outU = reg_0;	// @[generators/gemmini/src/main/scala/gemmini/Transposer.scala:110:24]
endmodule
