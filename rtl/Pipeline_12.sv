  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        stages_0_spad_addr = {_RANDOM[5'hA][31:13], _RANDOM[5'hB], _RANDOM[5'hC][12:0]};	// @[generators/gemmini/src/main/scala/gemmini/Pipeline.scala:21:21]
        stages_0_K = _RANDOM[5'hC][28:13];	// @[generators/gemmini/src/main/scala/gemmini/Pipeline.scala:21:21]
        stages_0_J = {_RANDOM[5'hC][31:29], _RANDOM[5'hD][12:0]};	// @[generators/gemmini/src/main/scala/gemmini/Pipeline.scala:21:21]
        stages_1_cmd_inst_funct = _RANDOM[5'hD][19:13];	// @[generators/gemmini/src/main/scala/gemmini/Pipeline.scala:21:21]
        stages_1_cmd_rs1 = {_RANDOM[5'hE][31:13], _RANDOM[5'hF], _RANDOM[5'h10][12:0]};	// @[generators/gemmini/src/main/scala/gemmini/Pipeline.scala:21:21]
        stages_1_cmd_rs2 = {_RANDOM[5'h10][31:13], _RANDOM[5'h11], _RANDOM[5'h12][12:0]};	// @[generators/gemmini/src/main/scala/gemmini/Pipeline.scala:21:21]
        stages_1_dram_addr = {_RANDOM[5'h15][31:22], _RANDOM[5'h16], _RANDOM[5'h17][25:0]};	// @[generators/gemmini/src/main/scala/gemmini/Pipeline.scala:21:21]
        stages_1_spad_addr = {_RANDOM[5'h17][31:26], _RANDOM[5'h18], _RANDOM[5'h19][25:0]};	// @[generators/gemmini/src/main/scala/gemmini/Pipeline.scala:21:21]
        stages_1_K = {_RANDOM[5'h19][31:26], _RANDOM[5'h1A][9:0]};	// @[generators/gemmini/src/main/scala/gemmini/Pipeline.scala:21:21]
        stages_1_J = _RANDOM[5'h1A][25:10];	// @[generators/gemmini/src/main/scala/gemmini/Pipeline.scala:21:21]
        valids_0 = _RANDOM[5'h1A][26];	// @[generators/gemmini/src/main/scala/gemmini/Pipeline.scala:21:21, :22:25]
        valids_1 = _RANDOM[5'h1A][27];	// @[generators/gemmini/src/main/scala/gemmini/Pipeline.scala:21:21, :22:25]
      `endif // RANDOMIZE_REG_INIT
    end // initial
