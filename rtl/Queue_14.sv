...
module Queue_14(
  ...
  reg  [87:0] ram;	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  ...
  always @(posedge clock) begin
    if (do_enq)	// @[src/main/scala/chisel3/util/Decoupled.scala:52:35]
      ram <= {1'h0, io_enq_bits_data, 2'h0, io_enq_bits_source, io_enq_bits_size, 2'h0, io_enq_bits_opcode};	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14, :274:95]
    if (reset)
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        ram = {_RANDOM[2'h0][31:1], _RANDOM[2'h1], _RANDOM[2'h2][24:0]};	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  ...
  assign io_deq_bits_param = ram[4:3];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_size = ram[6:5];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_source = ram[20:7];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_sink = ram[21];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_denied = ram[22];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_data = ram[86:23];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_corrupt = ram[87];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
endmodule
