...
module Queue_30(
  ...
  input  [2:0]  io_enq_bits_echo_tl_state_source,	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14]
  ...
  output [2:0]  io_deq_bits_echo_tl_state_source,	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14]
  ...
  assign io_deq_bits_id = full ? ram[2:0] : io_enq_bits_id;	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95, :277:27, :311:17, :316:17, :317:19]
  assign io_deq_bits_addr = full ? ram[34:3] : io_enq_bits_addr;	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95, :277:27, :311:17, :316:17, :317:19]
  assign io_deq_bits_len = full ? ram[42:35] : io_enq_bits_len;	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95, :277:27, :311:17, :316:17, :317:19]
  assign io_deq_bits_size = full ? ram[45:43] : io_enq_bits_size;	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95, :277:27, :311:17, :316:17, :317:19]
  assign io_deq_bits_burst = full ? ram[47:46] : 2'h1;	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95, :277:27, :311:17, :316:17, :317:19]
  assign io_deq_bits_lock = full & ram[48];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95, :277:27, :311:17, :316:17, :317:19]
  assign io_deq_bits_cache = full ? ram[52:49] : 4'h0;	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14, :274:95, :277:27, :311:17, :316:17, :317:19]
  assign io_deq_bits_prot = full ? ram[55:53] : 3'h1;	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14, :274:95, :277:27, :311:17, :316:17, :317:19]
  assign io_deq_bits_qos = full ? ram[59:56] : 4'h0;	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14, :274:95, :277:27, :311:17, :316:17, :317:19]
  assign io_deq_bits_echo_tl_state_size = full ? ram[63:60] : io_enq_bits_echo_tl_state_size;	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95, :277:27, :311:17, :316:17, :317:19]
  assign io_deq_bits_echo_tl_state_source = full ? ram[66:64] : io_enq_bits_echo_tl_state_source;	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95, :277:27, :311:17, :316:17, :317:19]
  assign io_deq_bits_wen = full ? ram[67] : io_enq_bits_wen;	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95, :277:27, :311:17, :316:17, :317:19]
endmodule
