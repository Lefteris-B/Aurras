...
module Queue_17(
  ...
  input  [2:0] io_enq_bits_tl_state_source,	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14]
  ...
  output [2:0] io_deq_bits_tl_state_source	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14]
);

  reg  [6:0] ram;	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        ram = _RANDOM[/*Zero width*/ 1'b0][7:1];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  ...
  assign io_deq_bits_tl_state_source = ram[6:4];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
endmodule
