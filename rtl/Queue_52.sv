...
module Queue_52(
  ...
  input  [2:0]  io_enq_bits_source,	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14]
  ...
  output [2:0]  io_deq_bits_source,	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14]
  output [63:0] io_deq_bits_data	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14]
);

  wire [73:0] _ram_ext_R0_data;	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  ...
  ram_2x74 ram_ext (	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
    ...
    .W0_clk  (clock),
    .W0_data ({io_enq_bits_data, io_enq_bits_source, io_enq_bits_size, io_enq_bits_opcode})	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  );
  ...
  assign io_deq_bits_size = _ram_ext_R0_data[6:3];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_source = _ram_ext_R0_data[9:7];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_data = _ram_ext_R0_data[73:10];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
endmodule
