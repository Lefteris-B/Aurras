...
module RecFNToIN_4(
  ...
  output [31:0] io_out,	// @[generators/hardfloat/hardfloat/src/main/scala/RecFNToIN.scala:48:16]
  ...
  wire [54:0] shiftedSig = {31'h0, io_in[31], io_in[22:0]} << (io_in[31] ? io_in[27:23] : 5'h0);	// @[generators/hardfloat/hardfloat/src/main/scala/RecFNToIN.scala:60:30, :82:49, :83:16, :84:27, :142:12, generators/hardfloat/hardfloat/src/main/scala/rawFloatFromRecFN.scala:61:49]
  ...
  wire [31:0] complUnroundedInt = {32{io_in[32]}} ^ shiftedSig[54:23];	// @[generators/hardfloat/hardfloat/src/main/scala/RecFNToIN.scala:82:49, :89:52, :102:32, generators/hardfloat/hardfloat/src/main/scala/rawFloatFromRecFN.scala:59:25]
  wire        magGeOne_atOverflowEdge = io_in[30:23] == 8'h1F;	// @[generators/hardfloat/hardfloat/src/main/scala/RecFNToIN.scala:61:28, :109:43]
  wire        common_overflow = io_in[31] & ((|(io_in[30:28])) | (io_in[32] ? magGeOne_atOverflowEdge & ((|(shiftedSig[53:23])) | roundIncr_near_even) : magGeOne_atOverflowEdge | io_in[30:23] == 8'h1E & (&(shiftedSig[52:23])) & roundIncr_near_even));	// @[generators/hardfloat/hardfloat/src/main/scala/RecFNToIN.scala:60:30, :61:28, :82:49, :89:52, :93:78, :109:43, :112:{38,56}, :114:12, :115:{21,36}, :117:24, :118:49, :119:{42,60,64}, :120:49, :121:{38,60}, generators/hardfloat/hardfloat/src/main/scala/rawFloatFromRecFN.scala:59:25]
